...
def train(args):
    ...
    for fold in range(k_fold):
        ...
        ds = Dataset(image_folder, image_size, train_split,anno_fold,aug_ratio=aug_ratio)
        ...
        #torch.save(class_net.state_dict(), 'models/classifier' + str(fold) + 'aug_' + str(aug_ratio) + '_test.pth')
        min_loss = 10
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_fold', type=str, default='/ISIC2018_Task3_Training_Aug/', help='train images including generated images')
